...
class Trainer(DefaultTrainer):
    ...
    # rewrite the initialization to enable find_unused_parameters, need to double check the correctness
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        ...
        evaluator_list.append(
            PlaneSegEvaluator(
                ...
                vis=not cfg.TEST.NO_VIS,
                vis_period=cfg.TEST.VIS_PERIOD,
                eval_period=cfg.TEST.EVAL_PERIOD,
                infer_only=cfg.TEST.INFER_ONLY,
                save_ply=cfg.TEST.SAVE_PLY,
