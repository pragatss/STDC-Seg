...
class DPTOutputAdapter_fix(DPTOutputAdapter):
    ...
    def get_intermediate_features(self, encoder_tokens: List[torch.Tensor], image_size=None):
        ...
        out = (path_4, path_3, path_2, path_1)
...
class PixelwiseTaskWithDPT(nn.Module):
    ...
    def forward(self, x, img_info, feature_only=False):
        if feature_only:
            out = self.dpt.get_intermediate_features(x, image_size=(img_info[0], img_info[1]))
