...
__all__ = ['SingleParallelDomainPlaneDatasetMapper']
...
class SingleParallelDomainPlaneDatasetMapper():
    """
    ...
    def __init__(
        ...
        *,
        ...
        logging.getLogger(__name__).info(
            "[ParallelDomainSinglePlaneDatasetMapper] Full TransformGens used in training: {}".format(
                str(self.tfm_gens)
            )
        )
