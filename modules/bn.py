...
class InPlaceABN(ABN):
    ...
    def forward(self, x):
        # Fall back to pure-PyTorch ABN to avoid inplace_abn autograd incompatibility
...
class InPlaceABNSync(ABN):
    ...
    def forward(self, x):
        # Fall back to pure-PyTorch ABN to avoid inplace_abn_sync autograd incompatibility
        # with newer PyTorch versions.
