...
__all__ = ['SingleSevenScenesPlaneDatasetMapper']
...
class SingleSevenScenesPlaneDatasetMapper():
    """
    ...
    def __init__(
        ...
        *,
        ...
        logging.getLogger(__name__).info(
            "[SevenScenesSinglePlaneDatasetMapper] Full TransformGens used in training: {}".format(
                str(self.tfm_gens)
            )
        )
